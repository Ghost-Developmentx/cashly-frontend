...
interface InvoiceDisplayProps {
    ...
    onDeleteInvoice?: (invoice: Invoice) => void;// Add this prop
}
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        {invoice.status === 'draft' && onDeleteInvoice && (
                                            <button
                                                onClick={() => {
                                                    if (confirm(`Are you sure you want to delete this draft invoice for ${invoice.client_name}? This action cannot be undone and will remove the invoice from both Cashly and Stripe.`)) {
